                ...
                <header class="top-nav">
                    ...
                    <div class="nav-right">
                        <div class="user-profile">
                            ...
                            <a href="<?php echo BASE_URL; ?>/logout.php" class="btn-logout"><i class="fas fa-sign-out-alt"></i></a>
                        </div>
                    </div>
                </header>
                    ...
                    <nav class="public-nav">
                        <div class="nav-container">
                            ...
                            <div class="nav-links">
                                ...
                                <?php if (is_logged_in()): ?>
                                    <a href="<?php echo BASE_URL; ?>/dashboard.php" class="btn btn-primary btn-sm">Dashboard</a>
                                <?php else: ?>
